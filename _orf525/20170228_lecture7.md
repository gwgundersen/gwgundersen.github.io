...
>
> $$
> \Omega \lambda \coloneqq \{ \mat{U} \coloneqq (u_1, ..., u_d) \in \mathbb{R}^d, \max_{j} \lVert u_j \rVert_2 \leq \lambda \}
> $$
>
> Where $(u_1, ..., u_d)$ are column vectors of $\mat{U}$.
...
$$
\max_{\mat{U} \in \Omega \lambda} \lVert \vec{Y} - (\mat{X} + \mat{U}) \rVert_2
$$