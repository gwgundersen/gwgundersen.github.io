...
$$
\vec{\beta}^{\text{OLS}} = \arg \min_{\vec{\beta}} \|\vec{Y} - \vec{X}\vec{\beta}\|_2^2 = (\textbf{X}^{\top}\textbf{X})^{-1} \textbf{X}^{\top} \vec{Y}
$$
...
$$
\vec{Y} = \vec{\beta}^{\top} \vec{X} + \epsilon
$$
...
$$
\hat{\vec{\beta}}^{\text{OLS}} = (\vec{X}^{\top} \vec{X})^{-1} \vec{X}^{\top} \vec{Y}
$$
...
The smallest value of $\vec{X}^{\top} \vec{X} + \lambda \vec{I_d}$ is at least $\lambda$, i.e. it's _stable_.

$$
\iff \hat{\vec{\beta}}^{\lambda} = \arg \min_{\vec{\beta}} \|\vec{Y} - \vec{X}\vec{\beta}\|_2^2 + \lambda \|\vec{\beta}\|_2^2 
$$

$$
\iff \hat{\vec{\beta}}^{\lambda} = \arg \min_{\|\vec{\beta}\|_2^2 \leq t} \|\vec{Y} - \vec{X}\vec{\beta}\|_2^2
$$
...
$$
\hat{\vec{\beta}}^{\lambda} = \arg \min_{\|\hat{\vec{\beta}}\|_2^2 \leq t} \|\vec{Y} - \vec{X} \vec{B}\|_2^2
$$
